...
const EditarLibro = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl mx-auto p-6 bg-white shadow rounded">
      ...
      <div className="mb-2 text-sm text-gray-500">Archivo actual: <a href={`http://localhost:3001${form.rutaPdf}`} target="_blank" rel="noreferrer" className="underline text-blue-600">Ver PDF</a></div>
