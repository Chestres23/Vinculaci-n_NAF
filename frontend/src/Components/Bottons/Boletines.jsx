        ...
        {!isLoggedIn ? (
          <div className="flex items-center justify-center w-full h-full">
            <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg transition-all duration-700 transform animate-slideUp">
              {view === "login" && (
                <>
                  <h2 className="text-green-800 text-2xl font-bold mb-4 text-center">Iniciar Sesión</h2>
          ...
          <section>
            <h2 className="text-3xl font-bold text-center text-blue-800 mb-6 lg:text-4xl">
              Boletines Contables
            </h2>
